...
public class NPCGraphicsComponent extends GraphicsComponent {
    ...
    private void drawSelected(Entity entity, MapManager mapMgr){
        ...
        float width =  rect.getWidth() * GameMap.UNIT_SCALE*2f;
        float height = rect.getHeight() * GameMap.UNIT_SCALE/2f;
        float x = rect.x * GameMap.UNIT_SCALE - width/4;
        float y = rect.y * GameMap.UNIT_SCALE - height/2;
